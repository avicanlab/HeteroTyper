...
data.params.max_colony_nr = 350; % maximal number of clean colonies allowed in plate
...
data.metadata.original = readtable('D:\Gizem\HeteroTyper\Metadata.xlsx','sheet','Meta_Dark');
