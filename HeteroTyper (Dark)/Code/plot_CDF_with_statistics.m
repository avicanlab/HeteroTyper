...
% 2. Run ->   lag_times = {combined_lag_time_MLN, combined_lag_time_Spleen, combined_lag_time_Liver};
% 3. Run ->   group_labels = {'MLN','Spleen','Liver'};
% 4. Run ->   colors = [0.035, 0.761, 0.624; 0.949, 0.494, 0.008; 0.541, 0.412, 0.831];
