...
function data = export_colony_img_intPerSize_threshold(data)
    ...
    Size_threshold = 200;
    Ecc_threshold  = 0.7;
    IntS_thr_L = 25;       % Define lowest IntensityPerSize threshold that must be filtered
    IntS_thr_H = 75;       % Define highest IntensityPerSize threshold that must be filtered
    
    crop_size = 150;

    file_path = 'D:\Gizem\HeteroTyper\Test_Dark\Test_output\Colony Images - IntensitySize threshold\';
